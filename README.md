...
It comes batterly-included with monitoring, logging and a high-performance [server](./server). In addition, a [TypeScript client library](./clients/TypeScript) is available and provide a fully static and type-safe interface for Cardano in TypeScript.
